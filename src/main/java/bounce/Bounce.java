...
public class Bounce {
    ...
    private static final RegistryObject<Item> POGO = POGO_REGISTRY.register("wooden_pogo_stick",  () -> new Item(new Item.Properties().tab(ItemGroup.TAB_TRANSPORTATION).stacksTo(1).durability(100)));
